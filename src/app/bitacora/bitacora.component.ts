...
export class BitacoraComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.socket.on('agregarReserva', (data: any) => {
            ...
            // console.log(timeInicio,timeReserva,timeFinal);
            // console.log(auxReservaInicio,auxReserva,auxReservaFinal);

            // if(data.id_vehiculo == this.selectedVehiculo && (timeInicio >= timeReserva  &&  timeReserva <= timeFinal)){
            if(data.id_vehiculo == this.selectedVehiculo){
                this.solicitarReservas();
    ...
    openEditDialog(dataEdit:bitacora){
        ...
        if(this.cargo == 'chofer'){
            ...
            console.log(this.idUsuario,dataEdit.id_usuario);
